  ...
  return (
    <div className='min-h-screen flex flex-col gap-10 items-center justify-center text-center max-w-[900px] w-full mx-auto p-4'>
        <div className='flex flex-col gap-4'>
          ...
          <h1 className='uppercase font-semibold text-4xl sm:text-5xl md:text-6xl lg:text-7l'>Swole<span className='text-blue-400'>normous</span></h1>
        </div>
        ...
        <button className='px-8 py-4 rounded-md border-2 border-blue-400 border-solid bg-slate-950 blueShadow duration-200'><p>Accept & Begin</p></button>
    </div>
  )
}